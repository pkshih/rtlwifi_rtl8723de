...
void phydm_bb_dbg_port_header_sel(void *p_dm_void, u32 header_idx)
{
	...
	if (p_dm->support_ic_type & ODM_IC_11AC_SERIES) {
		...
		odm_set_bb_reg(p_dm, BBREG_0x8f8,
...
void phydm_bb_dbg_port_clock_en(void *p_dm_void, u8 enable)
{
	...
	if (p_dm->support_ic_type &
		...
		odm_set_bb_reg(
			p_dm, BBREG_0x198c, 0x7,
			reg_value); /*enable/disable debug port clock, for power saving*/
	}
}
...
u8 phydm_set_bb_dbg_port(void *p_dm_void, u8 curr_dbg_priority, u32 debug_port)
{
	...
	if (curr_dbg_priority > p_dm->pre_dbg_priority) {
		if (p_dm->support_ic_type & ODM_IC_11AC_SERIES) {
			...
			odm_set_bb_reg(p_dm, BBREG_0x8fc, MASKDWORD,
				       debug_port);
			/**/
		} else /*if (p_dm->support_ic_type & ODM_IC_11N_SERIES)*/ {
			odm_set_bb_reg(p_dm, BBREG_0x908, MASKDWORD,
				       debug_port);
			/**/
		}
		PHYDM_DBG(
			...
			("DbgPort ((0x%x)) set success, Cur_priority=((%d)), Pre_priority=((%d))\n",
			 debug_port, curr_dbg_priority,
			 p_dm->pre_dbg_priority));
...
u32 phydm_get_bb_dbg_port_value(void *p_dm_void)
{
	...
	if (p_dm->support_ic_type & ODM_IC_11AC_SERIES) {
		dbg_port_value = odm_get_bb_reg(p_dm, BBREG_0xfa0, MASKDWORD);
		/**/
	} else /*if (p_dm->support_ic_type & ODM_IC_11N_SERIES)*/ {
		dbg_port_value = odm_get_bb_reg(p_dm, BBREG_0xdf4, MASKDWORD);
		/**/
	}
...
void phydm_bb_debug_info_n_series(void *p_dm_void, u32 *_used, char *output,
				  u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 used = *_used;
	...
	/*AGC result*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdd0, MASKDWORD);
	...
	/*SNR report*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdd4, MASKDWORD);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdd8, MASKDWORD);
	...
	/*CFO Report Info*/
	odm_set_bb_reg(p_dm, BBREG_0xd00, BIT(26), 1);

	/*Short CFO*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdac, MASKDWORD);
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xdb0, MASKDWORD);
	...
	/*SCFO*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdb8, MASKDWORD);
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xdb4, MASKDWORD);

	scfo_b = (s32)(value32 & BBREG_0x7ff); /*S(11,10)*/
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xdbc, MASKDWORD);
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xde0, MASKDWORD);
...
void phydm_bb_debug_info(void *p_dm_void, u32 *_used, char *output,
			 u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 used = *_used;
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf80, MASKDWORD);
	value32_2 = value32;
	rx_ht_bw = (u8)(value32 & 0x1);
	rx_vht_bw = (u8)((value32 >> 1) & 0x3);
	rxsc = (u8)(value32 & 0x78);
	value32_1 = (value32 & BBREG_0x180) >> 7;
	rx_ht = (u8)(value32_1);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf90, MASKDWORD);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xd14, MASKDWORD);
	rx_snr_path_a = (u8)(value32 & 0xFF) >> 1;
	rf_gain_path_a = (s8)((value32 & MASKBYTE1) >> 8);
	rf_gain_path_a *= 2;
	value32 = odm_get_bb_reg(p_dm, BBREG_0xd54, MASKDWORD);
	rx_snr_path_b = (u8)(value32 & 0xFF) >> 1;
	rf_gain_path_b = (s8)((value32 & MASKBYTE1) >> 8);
	rf_gain_path_b *= 2;
	value32 = odm_get_bb_reg(p_dm, BBREG_0xd94, MASKDWORD);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf08, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d",
			"OFDM CCA counter", ((value32 & 0xFFFF0000) >> 16)));

	value32 = odm_get_bb_reg(p_dm, BBREG_0xfd0, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d",
			"OFDM SBD Fail counter", value32 & 0xFFFF));

	value32 = odm_get_bb_reg(p_dm, BBREG_0xfc4, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d / %d",
			"VHT SIGA/SIGB CRC8 Fail counter", value32 & 0xFFFF,
			((value32 & 0xFFFF0000) >> 16)));

	value32 = odm_get_bb_reg(p_dm, BBREG_0xfcc, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d",
			"CCK CCA counter", value32 & 0xFFFF));

	value32 = odm_get_bb_reg(p_dm, BBREG_0xfbc, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d / %d",
			"LSIG (parity Fail/rate Illegal) counter",
			value32 & 0xFFFF, ((value32 & 0xFFFF0000) >> 16)));

	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xfc8, MASKDWORD);
	value32_2 = odm_get_bb_reg(p_dm, BBREG_0xfc0, MASKDWORD);
	PHYDM_SNPRINTF((output + used, out_len - used, "\r\n %-35s = %d / %d",
			"HT/VHT MCS NOT SUPPORT counter",
			((value32_2 & 0xFFFF0000) >> 16), value32_1 & 0xFFFF));

	/* PostFFT related info*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf8c, MASKDWORD);
	rxevm_0 = (s8)((value32 & MASKBYTE2) >> 16);
	rxevm_0 /= 2;
	if (rxevm_0 < -63)
		rxevm_0 = 0;
	...
	rxevm_1 = (s8)((value32 & MASKBYTE3) >> 24);
	rxevm_1 /= 2;
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf88, MASKDWORD);
	...
	odm_set_bb_reg(p_dm, BBREG_0xb58, BIT(0), 1);
	odm_set_bb_reg(p_dm, BBREG_0xb58, BIT(0), 0);

	/*CFO Report Info*/
	/*Short CFO*/
	value32 = odm_get_bb_reg(p_dm, BBREG_0xd0c, MASKDWORD);
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xd4c, MASKDWORD);
	value32_2 = odm_get_bb_reg(p_dm, BBREG_0xd8c, MASKDWORD);
	value32_3 = odm_get_bb_reg(p_dm, BBREG_0xdcc, MASKDWORD);
	...
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xd50, MASKDWORD);
	value32_2 = odm_get_bb_reg(p_dm, BBREG_0xd90, MASKDWORD);
	value32_3 = odm_get_bb_reg(p_dm, BBREG_0xdd0, MASKDWORD);

	sfo_a = (s32)(value32 & BBREG_0x7ff);
	sfo_b = (s32)(value32_1 & BBREG_0x7ff);
	sfo_c = (s32)(value32_2 & BBREG_0x7ff);
	sfo_d = (s32)(value32_3 & BBREG_0x7ff);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xd14, MASKDWORD);
	value32_1 = odm_get_bb_reg(p_dm, BBREG_0xd54, MASKDWORD);
	value32_2 = odm_get_bb_reg(p_dm, BBREG_0xd94, MASKDWORD);
	value32_3 = odm_get_bb_reg(p_dm, BBREG_0xdd4, MASKDWORD);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf20, MASKDWORD); /*L SIG*/
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf2c, MASKDWORD); /*HT SIG*/
	if (rx_ht == 1) {
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf30, MASKDWORD); /*HT SIG*/
	...
	if (rx_ht == 1) {
		...
		fec = (u8)(value32 & 0x40);
		sgi = (u8)(value32 & 0x80);
		htltf = (u8)((value32 & BBREG_0x300) >> 8);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf30, MASKDWORD); /*VHT SIG*/
	...
	if (rx_ht == 2) {
		...
		bf = (u8)((value32 & BBREG_0x100) >> 8);
		vrsv = (u8)((value32 & BBREG_0x200) >> 8);
	...
	value32 = odm_get_bb_reg(p_dm, BBREG_0xf34, MASKDWORD); /*VHT SIG*/
	{
	...
	if (p_dm->support_ic_type & ODM_RTL8822B) {
		...
		odm_set_bb_reg(p_dm, BBREG_0x1988, BIT(22),
			       0x1); /*enable report condition number*/

		condition_num = odm_get_bb_reg(p_dm, BBREG_0xf84, MASKDWORD);
...
)
{
	...
	if (sbd_state == 0) {
		...
		value32 = odm_get_bb_reg(p_dm, BBREG_0xf98, MASKDWORD);
...
void phydm_reset_rx_rate_distribution(struct PHY_DM_STRUCT *p_dm_odm)
{
	...
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_legacy_pkt[0], 0,
		       (LEGACY_RATE_NUM * 2));
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_ht_pkt[0], 0,
		       (HT_RATE_NUM * 2));
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_ht_pkt_20m[0], 0,
		       (LOW_BW_RATE_NUM * 2));

	p_dbg->ht_pkt_not_zero = false;
	p_dbg->ht_low_bw_occur = false;

#if	ODM_IC_11AC_SERIES_SUPPORT
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_vht_pkt[0], 0,
		       (VHT_RATE_NUM * 2));
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_vht_pkt_20m[0], 0,
		       (LOW_BW_RATE_NUM * 2));
	odm_memory_set(p_dm_odm, &p_dbg->num_qry_vht_pkt_40m[0], 0,
		       (LOW_BW_RATE_NUM * 2));

	p_dbg->vht_pkt_not_zero = false;
	p_dbg->vht_low_bw_occur = false;
#endif
}
...
void phydm_rx_rate_distribution(void *p_dm_void)
{
	...
	if (*p_dm->p_channel <= 14) {
		PHYDM_DBG(p_dm, ODM_COMP_COMMON,
			  ("* CCK = {%d, %d, %d, %d}\n",
	...
	PHYDM_DBG(p_dm, ODM_COMP_COMMON,
		  ("* OFDM = {%d, %d, %d, %d, %d, %d, %d, %d}\n",
		   ...
		   p_dbg->num_qry_legacy_pkt[10],
		   p_dbg->num_qry_legacy_pkt[11]));
	...
	if (p_dbg->ht_pkt_not_zero) {
		...
		for (i = 0; i < rate_num; i++) {
			...
			PHYDM_DBG(
				p_dm, ODM_COMP_COMMON,
				("* HT MCS[%d :%d ] = {%d, %d, %d, %d, %d, %d, %d, %d}\n",
				 (rate_ss_shift), (rate_ss_shift + 7),
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 0],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 1],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 2],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 3],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 4],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 5],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 6],
				 p_dbg->num_qry_ht_pkt[rate_ss_shift + 7]));
		}
	}

	if (p_dbg->ht_low_bw_occur) {
		PHYDM_DBG(p_dm, ODM_COMP_COMMON,
			  ("*[Low BW 20M] HT MCS[0:1] = {%d, %d}\n",
			   p_dbg->num_qry_ht_pkt_20m[0],
			   p_dbg->num_qry_ht_pkt_20m[1]));
	}
		...
		for (i = 0; i < rate_num; i++) {
			...
			PHYDM_DBG(
				...
				("* VHT-%d ss MCS[0:9] = {%d, %d, %d, %d, %d, %d, %d, %d, %d, %d}\n",
				 (i + 1),
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 0],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 1],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 2],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 3],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 4],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 5],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 6],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 7],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 8],
				 p_dbg->num_qry_vht_pkt[rate_ss_shift + 9]));
		}
	}

	if (p_dbg->vht_low_bw_occur) {
		PHYDM_DBG(p_dm, ODM_COMP_COMMON,
			  ("*[Low BW 20M] VHT 1SS MCS[0:1] = {%d, %d}\n",
			   p_dbg->num_qry_vht_pkt_20m[0],
			   p_dbg->num_qry_vht_pkt_20m[1]));

		PHYDM_DBG(p_dm, ODM_COMP_COMMON,
			  ("*[Low BW 40M] VHT 1SS MCS[0:1] = {%d, %d}\n",
			   p_dbg->num_qry_vht_pkt_40m[0],
			   p_dbg->num_qry_vht_pkt_40m[1]));
	}
#endif
}
...
void phydm_get_avg_phystatus_val(void *p_dm_void)
{
	...
	/*CCK*/
	p_dbg_avg->rssi_cck_avg = (u8)((p_dbg_statistic->rssi_cck_cnt != 0) ?
	...
	if (p_dbg_statistic->rssi_ofdm_cnt != 0) {
		p_dbg_avg->rssi_ofdm_avg = (u8)(p_dbg_statistic->rssi_ofdm_sum /
						p_dbg_statistic->rssi_ofdm_cnt);
		p_dbg_avg->evm_ofdm_avg = (u8)(p_dbg_statistic->evm_ofdm_sum /
					       p_dbg_statistic->rssi_ofdm_cnt);
		p_dbg_avg->snr_ofdm_avg = (u8)(p_dbg_statistic->snr_ofdm_sum /
					       p_dbg_statistic->rssi_ofdm_cnt);
	}
	...
	PHYDM_DBG(p_dm, ODM_COMP_COMMON,
		  ("* ofdm Cnt= ((%d)) RSSI:{%d} EVM:{%d} SNR:{%d}\n",
		   ...
		   p_dbg_avg->evm_ofdm_avg, p_dbg_avg->snr_ofdm_avg));

	if (p_dbg_statistic->rssi_1ss_cnt != 0) {
		p_dbg_avg->rssi_1ss_avg = (u8)(p_dbg_statistic->rssi_1ss_sum /
					       p_dbg_statistic->rssi_1ss_cnt);
		p_dbg_avg->evm_1ss_avg = (u8)(p_dbg_statistic->evm_1ss_sum /
					      p_dbg_statistic->rssi_1ss_cnt);
		p_dbg_avg->snr_1ss_avg = (u8)(p_dbg_statistic->snr_1ss_sum /
					      p_dbg_statistic->rssi_1ss_cnt);
	}

	PHYDM_DBG(p_dm, ODM_COMP_COMMON,
		  ("* 1-ss Cnt= ((%d)) RSSI:{%d} EVM:{%d} SNR:{%d}\n",
		   p_dbg_statistic->rssi_1ss_cnt, p_dbg_avg->rssi_1ss_avg,
		   p_dbg_avg->evm_1ss_avg, p_dbg_avg->snr_1ss_avg));

	#if (defined(PHYDM_COMPILE_ABOVE_2SS))
	if (p_dm->support_ic_type & (PHYDM_IC_ABOVE_2SS)) {
		if (p_dbg_statistic->rssi_2ss_cnt != 0) {
			p_dbg_avg->rssi_2ss_avg[0] =
				(u8)(p_dbg_statistic->rssi_2ss_sum[0] /
				     p_dbg_statistic->rssi_2ss_cnt);
			p_dbg_avg->rssi_2ss_avg[1] =
				(u8)(p_dbg_statistic->rssi_2ss_sum[1] /
				     p_dbg_statistic->rssi_2ss_cnt);

			p_dbg_avg->evm_2ss_avg[0] =
				(u8)(p_dbg_statistic->evm_2ss_sum[0] /
				     p_dbg_statistic->rssi_2ss_cnt);
			p_dbg_avg->evm_2ss_avg[1] =
				(u8)(p_dbg_statistic->evm_2ss_sum[1] /
				     p_dbg_statistic->rssi_2ss_cnt);

			p_dbg_avg->snr_2ss_avg[0] =
				(u8)(p_dbg_statistic->snr_2ss_sum[0] /
				     p_dbg_statistic->rssi_2ss_cnt);
			p_dbg_avg->snr_2ss_avg[1] =
				(u8)(p_dbg_statistic->snr_2ss_sum[1] /
				     p_dbg_statistic->rssi_2ss_cnt);
		}
...
void phydm_get_phy_statistic(void *p_dm_void)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
...
void phydm_basic_dbg_message(void *p_dm_void)
{
	...
	struct phydm_cfo_track_struct *p_cfo_track =
	...
	if (p_dm->is_linked) {
		PHYDM_DBG(p_dm, ODM_COMP_COMMON,
			  ("ID=((%d)), BW=((%d)), fc=((CH-%d))\n",
			   p_dm->curr_station_id, 20 << *p_dm->p_band_width,
			   *p_dm->p_channel));

		if ((*p_dm->p_channel <= 14) &&
		    (*p_dm->p_band_width == CHANNEL_WIDTH_40)) {
			PHYDM_DBG(
				p_dm, ODM_COMP_COMMON,
				("Primary CCA at ((%s SB))\n",
				 ((*p_dm->p_sec_ch_offset == SECOND_CH_AT_LSB) ?
					  "U" :
					  "L")));
		}

		if ((p_dm->support_ic_type & ODM_IC_PHY_STATUE_NEW_TYPE) ||
		    p_dm->rx_rate > ODM_RATE11M) {

			PHYDM_DBG(p_dm, ODM_COMP_COMMON,
				  ("[AGC Idx] {0x%x, 0x%x, 0x%x, 0x%x}\n",
				   p_dm->ofdm_agc_idx[0], p_dm->ofdm_agc_idx[1],
				   p_dm->ofdm_agc_idx[2],
				   p_dm->ofdm_agc_idx[3]));
		} else {
		...
		for (macid = 0; macid < ODM_ASSOCIATE_ENTRY_NUM; macid++) {
			...
			PHYDM_DBG(p_dm, ODM_COMP_COMMON,
				  ("TxRate[%d]:", macid));
			phydm_print_rate(p_dm, p_entry->ra_info.curr_tx_rate,
					 ODM_COMP_COMMON);
		...
		PHYDM_DBG(
			...
			("TP {Tx, Rx, Total} = {%d, %d, %d}Mbps, Traffic_Load=(%d))\n",
			 p_dm->tx_tp, p_dm->rx_tp, p_dm->total_tp,
			 p_dm->traffic_load));
		...
		PHYDM_DBG(
			p_dm, ODM_COMP_COMMON,
			("CFO_avg = ((%d kHz)) , CFO_tracking = ((%s%d))\n",
...
/* Condition number */
		...
		if (p_dm->support_ic_type & ODM_IC_PHY_STATUE_NEW_TYPE)
			PHYDM_DBG(
				...
				("Coding: LDPC=((%s)), STBC=((%s))\n",
				 (p_dm->phy_dbg_info.is_ldpc_pkt) ? "Y" : "N",
				 (p_dm->phy_dbg_info.is_stbc_pkt) ? "Y" : "N"));
	#endif
	} else
	...
	PHYDM_DBG(
		...
		("is_linked = %d, Num_client = %d, rssi_min = %d, IGI = 0x%x, bNoisy=%d\n\n",
		 p_dm->is_linked, p_dm->number_linked_client, p_dm->rssi_min,
		 p_dig_t->cur_ig_value, p_dm->noisy_decision));

#endif
}

void phydm_basic_profile(void *p_dm_void, u32 *_used, char *output,
			 u32 *_out_len)
{
#ifdef CONFIG_PHYDM_DEBUG_FUNCTION
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
...
/* JJ ADD 20161014 */
	...
	halrf_basic_profile(p_dm_void, _used, output, _out_len);
...
#ifdef CONFIG_PHYDM_DEBUG_FUNCTION
void phydm_fw_trace_en_h2c(void *p_dm_void, boolean enable,
			   u32 fw_debug_component, u32 monitor_mode, u32 macid)
{
	...
	odm_fill_h2c_cmd(p_dm, PHYDM_H2C_FW_TRACE_EN, cmd_length,
			 h2c_parameter);
}

void phydm_get_per_path_txagc(void *p_dm_void, u8 path, u32 *_used,
			      char *output, u32 *_out_len)
{
	...
	if (((p_dm->support_ic_type & (ODM_RTL8822B | ODM_RTL8197F)) &&
		...
		for (rate_idx = 0; rate_idx <= 0x53; rate_idx++) {
			...
			txagc = phydm_api_get_txagc(p_dm, (enum rf_path)path,
						    rate_idx);
...
void phydm_get_txagc(void *p_dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 used = *_used;
	u32 out_len = *_out_len;
...
void phydm_set_txagc(void *p_dm_void, u32 *const dm_value, u32 *_used,
		     char *output, u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 used = *_used;
...
/*dm_value[3] = power_index*/
	...
	if (p_dm->support_ic_type &
		...
		if ((u8)dm_value[2] != 0xff) {
			if (phydm_api_set_txagc(p_dm, dm_value[3],
						(enum rf_path)dm_value[1],
						(u8)dm_value[2], true))
				PHYDM_SNPRINTF((output + used, out_len - used,
						"  %s%d   %s%x%s%x\n",
						"Write path-", dm_value[1],
						"rate index-0x", dm_value[2],
						" = 0x", dm_value[3]));
			else
				PHYDM_SNPRINTF(
					(output + used, out_len - used,
...
void phydm_debug_trace(void *p_dm_void, char input[][16], u32 *_used,
		       char *output, u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	...
	if (dm_value[0] == 100) {
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 ...
			 ((p_dm->debug_components & DBG_RSSI_MNTR) ? ("V") :
								     ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "05. (( %s ))CCKPD\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "06. (( %s ))ANT_DIV\n",
			 ((p_dm->debug_components & DBG_ANT_DIV) ? ("V") :
								   ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "07. (( %s ))SMT_ANT\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 ...
			 ((p_dm->debug_components & F08_PWR_TRAIN) ? ("V") :
								     ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "09. (( %s ))RA\n",
		...
		PHYDM_SNPRINTF((
			...
			((p_dm->debug_components & DBG_PATH_DIV) ? ("V") :
								   ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "11. (( %s ))DFS\n",
			 ((p_dm->debug_components & DBG_DFS) ? ("V") : ("."))));
		PHYDM_SNPRINTF((
			output + used, out_len - used, "12. (( %s ))DYN_ARFR\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 ...
			 ((p_dm->debug_components & DBG_ADPTVTY) ? ("V") :
								   ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "14. (( %s ))CFO_TRK\n",
			 ((p_dm->debug_components & DBG_CFO_TRK) ? ("V") :
								   ("."))));
		PHYDM_SNPRINTF((
			output + used, out_len - used, "15. (( %s ))ENV_MNTR\n",
			((p_dm->debug_components & DBG_ENV_MNTR) ? ("V") :
								   ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "16. (( %s ))PRI_CCA\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 ...
			 ((p_dm->debug_components & DBG_LNA_SAT_CHK) ? ("V") :
								       ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "19. (( %s ))DRP\n",
			 ((p_dm->debug_components & DBG_DYN_RX_PATH) ? ("V") :
								       ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 "20. (( %s ))PHY_STATUS\n",
			 ((p_dm->debug_components & DBG_PHY_STATUS) ? ("V") :
								      ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "21. (( %s ))TMP\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 ...
			 ((p_dm->debug_components & DBG_FW_TRACE) ? ("V") :
								    ("."))));
		PHYDM_SNPRINTF((
			output + used, out_len - used, "23. (( %s ))TXBF\n",
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 "25. (( %s ))TX_PWR_TRK\n",
			 ((p_dm->debug_components & ODM_COMP_TX_PWR_TRACK) ?
				  ("V") :
				  ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
			 "26. (( %s ))CALIBRATION\n",
			 ((p_dm->debug_components & ODM_COMP_CALIBRATION) ?
				  ("V") :
				  ("."))));
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "27. (( %s ))MP\n",
		...
		if ((BIT(dm_value[0]) == DBG_PHY_STATUS) &&
		    (dm_value[1] == 1)) {
			p_dm->phy_dbg_info.show_phy_sts_all_pkt =
				(u8)dm_value[2];
			p_dm->phy_dbg_info.show_phy_sts_max_cnt =
				(u16)dm_value[3];
...
void phydm_fw_debug_trace(void *p_dm_void, u32 *const dm_value, u32 *_used,
			  char *output, u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	...
	if (dm_value[0] == 100) {
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "00. (( %s ))RA\n",
			 ((p_dm->fw_debug_components & PHYDM_FW_COMP_RA) ?
				  ("V") :
				  ("."))));
		...
		if (p_dm->fw_debug_components == 0) {
			...
			phydm_fw_trace_en_h2c(
				p_dm, false, p_dm->fw_debug_components,
				dm_value[2],
				dm_value[3]); /*H2C to enable C2H Msg*/
		} else {
			p_dm->debug_components |= DBG_FW_TRACE;
			phydm_fw_trace_en_h2c(
				p_dm, true, p_dm->fw_debug_components,
				dm_value[2],
				dm_value[3]); /*H2C to enable C2H Msg*/
		}
	}
...
void phydm_dump_bb_reg(void *p_dm_void, u32 *_used, char *output, u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 addr = 0;
	u32 used = *_used;
	...
	for (addr = BBREG_0x800; addr < 0xfff; addr += 4) {
		if (p_dm->support_ic_type & ODM_IC_11N_SERIES)
			PHYDM_VAST_INFO_SNPRINTF(
				(output + used, out_len - used,
				 "0x%03x 0x%08x\n", addr,
				 odm_get_bb_reg(p_dm, addr, MASKDWORD)));
		else
			PHYDM_VAST_INFO_SNPRINTF(
				(output + used, out_len - used,
				 "0x%04x 0x%08x\n", addr,
...
void phydm_dump_all_reg(void *p_dm_void, u32 *_used, char *output,
			u32 *_out_len)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	u32 addr = 0;
	...
	for (addr = 0; addr < BBREG_0x7ff; addr += 4)
		PHYDM_VAST_INFO_SNPRINTF(
			(output + used, out_len - used, "0x%04x 0x%08x\n", addr,
			 odm_get_bb_reg(p_dm, addr, MASKDWORD)));
	...
	for (addr = 0; addr < 0xFF; addr++)
		PHYDM_VAST_INFO_SNPRINTF((output + used, out_len - used,
					  "0x%02x 0x%05x\n", addr,
					  odm_get_rf_reg(p_dm, RF_PATH_A, addr,
							 RFREGOFFSETMASK)));
	...
	if (p_dm->rf_type > RF_1T1R) {
		...
		for (addr = 0; addr < 0xFF; addr++)
			PHYDM_VAST_INFO_SNPRINTF(
				(output + used, out_len - used,
				 "0x%02x 0x%05x\n", addr,
				 odm_get_rf_reg(p_dm, RF_PATH_B, addr,
						RFREGOFFSETMASK)));
	}
	...
	if (p_dm->rf_type > RF_2T2R) {
		...
		for (addr = 0; addr < 0xFF; addr++)
			PHYDM_VAST_INFO_SNPRINTF(
				(output + used, out_len - used,
				 "0x%02x 0x%05x\n", addr,
				 odm_get_rf_reg(p_dm, RF_PATH_C, addr,
						RFREGOFFSETMASK)));
	}
	...
	if (p_dm->rf_type > RF_3T3R) {
		...
		for (addr = 0; addr < 0xFF; addr++)
			PHYDM_VAST_INFO_SNPRINTF(
				(output + used, out_len - used,
				 "0x%02x 0x%05x\n", addr,
				 odm_get_rf_reg(p_dm, RF_PATH_D, addr,
						RFREGOFFSETMASK)));
	}
...
void phydm_enable_big_jump(struct PHY_DM_STRUCT *p_dm, boolean state)
{
#if (RTL8822B_SUPPORT == 1)
	struct phydm_dig_struct *p_dig_t = &p_dm->dm_dig_table;
	...
	if (state == false) {
		...
		odm_set_bb_reg(p_dm, BBREG_0x8c8, 0xfe,
			       ((p_dig_t->big_jump_step3 << 5) |
				(p_dig_t->big_jump_step2 << 3) |
				p_dig_t->big_jump_step1));
	} else
...
void phydm_show_rx_rate(struct PHY_DM_STRUCT *p_dm, u32 *_used, char *output,
			u32 *_out_len)
{
	u32 used = *_used;
	u32 out_len = *_out_len;
	...
	PHYDM_SNPRINTF((
		...
		p_dm->phy_dbg_info.num_qry_vht_pkt[0],
		p_dm->phy_dbg_info.num_qry_vht_pkt[1],
		p_dm->phy_dbg_info.num_qry_vht_pkt[2],
		p_dm->phy_dbg_info.num_qry_vht_pkt[3]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"1SS MCS4 = %d, 1SS MCS5 = %d, 1SS MCS6 = %d, 1SS MCS 7 = %d\n",
		p_dm->phy_dbg_info.num_qry_vht_pkt[4],
		p_dm->phy_dbg_info.num_qry_vht_pkt[5],
		p_dm->phy_dbg_info.num_qry_vht_pkt[6],
		p_dm->phy_dbg_info.num_qry_vht_pkt[7]));
	PHYDM_SNPRINTF((output + used, out_len - used,
			"1SS MCS8 = %d, 1SS MCS9 = %d\n",
			p_dm->phy_dbg_info.num_qry_vht_pkt[8],
			p_dm->phy_dbg_info.num_qry_vht_pkt[9]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"2SS MCS0 = %d, 2SS MCS1 = %d, 2SS MCS2 = %d, 2SS MCS 3 = %d\n",
		p_dm->phy_dbg_info.num_qry_vht_pkt[10],
		p_dm->phy_dbg_info.num_qry_vht_pkt[11],
		p_dm->phy_dbg_info.num_qry_vht_pkt[12],
		p_dm->phy_dbg_info.num_qry_vht_pkt[13]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"2SS MCS4 = %d, 2SS MCS5 = %d, 2SS MCS6 = %d, 2SS MCS 7 = %d\n",
		p_dm->phy_dbg_info.num_qry_vht_pkt[14],
		p_dm->phy_dbg_info.num_qry_vht_pkt[15],
		p_dm->phy_dbg_info.num_qry_vht_pkt[16],
		p_dm->phy_dbg_info.num_qry_vht_pkt[17]));
	PHYDM_SNPRINTF((output + used, out_len - used,
			"2SS MCS8 = %d, 2SS MCS9 = %d\n",
			p_dm->phy_dbg_info.num_qry_vht_pkt[18],
			p_dm->phy_dbg_info.num_qry_vht_pkt[19]));
	...
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"1SS MCS0 = %d, 1SS MCS1 = %d, 1SS MCS2 = %d, 1SS MCS 3 = %d\n",
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[0],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[1],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[2],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[3]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"1SS MCS4 = %d, 1SS MCS5 = %d, 1SS MCS6 = %d, 1SS MCS 7 = %d\n",
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[4],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[5],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[6],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[7]));
	PHYDM_SNPRINTF((output + used, out_len - used,
			"1SS MCS8 = %d, 1SS MCS9 = %d\n",
			p_dm->phy_dbg_info.num_qry_mu_vht_pkt[8],
			p_dm->phy_dbg_info.num_qry_mu_vht_pkt[9]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"2SS MCS0 = %d, 2SS MCS1 = %d, 2SS MCS2 = %d, 2SS MCS 3 = %d\n",
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[10],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[11],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[12],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[13]));
	PHYDM_SNPRINTF((
		output + used, out_len - used,
		"2SS MCS4 = %d, 2SS MCS5 = %d, 2SS MCS6 = %d, 2SS MCS 7 = %d\n",
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[14],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[15],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[16],
		p_dm->phy_dbg_info.num_qry_mu_vht_pkt[17]));
	PHYDM_SNPRINTF((output + used, out_len - used,
			"2SS MCS8 = %d, 2SS MCS9 = %d\n",
			p_dm->phy_dbg_info.num_qry_mu_vht_pkt[18],
			p_dm->phy_dbg_info.num_qry_mu_vht_pkt[19]));
...
void phydm_per_tone_evm(void *p_dm_void, char input[][16], u32 *_used,
			char *output, u32 *_out_len, u32 input_num)
{
	...
	if (p_dm->support_ic_type & ODM_IC_11N_SERIES) {
		dbg_print("n series not support yet !\n");
		return;
	}
	...
	if (p_dm->is_linked) {
		dbg_print("ID=((%d)), BW=((%d)), fc=((CH-%d))\n",
			  p_dm->curr_station_id, 20 << *p_dm->p_band_width,
			  *p_dm->p_channel);
		dbg_print("avg_num =((%d)), round =((%d))\n", avg_num, round);
		...
		for (j = 0; j < round; j++) {
			...
			if (*p_dm->p_band_width == CHANNEL_WIDTH_20) {
				for (tone_num = 228; tone_num <= 255;
				     tone_num++) {
					odm_set_bb_reg(p_dm, BBREG_0x8c4, 0xff8,
						       tone_num);
					rxevm_sum_0 = 0;
					rxevm_sum_1 = 0;
					for (i = 0; i < avg_num; i++) {
		...
		PHYDM_SNPRINTF((output + used, out_len - used, "No Link !!\n"));
}

void phydm_api_adjust(void *p_dm_void, char input[][16], u32 *_used,
		      char *output, u32 *_out_len, u32 input_num)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	char help[] = "-h";
	...
	if ((p_dm->support_ic_type &
	     (ODM_RTL8822B | ODM_RTL8197F | ODM_RTL8821C)) == 0) {
		PHYDM_SNPRINTF(
			(output + used, out_len - used,
	...
	if (is_enable_dbg_mode) {
		...
		phydm_api_switch_bw_channel(p_dm, central_ch, primary_ch_idx,
					    bandwidth);
...
void phydm_parameter_adjust(void *p_dm_void, char input[][16], u32 *_used,
			    char *output, u32 *_out_len, u32 input_num)
{
	struct PHY_DM_STRUCT *p_dm = (struct PHY_DM_STRUCT *)p_dm_void;
	struct phydm_cfo_track_struct *p_cfo_track =
...
void phydm_cmd_parser(struct PHY_DM_STRUCT *p_dm, char input[][MAX_ARGV],
		      u32 input_num, u8 flag, char *output, u32 out_len)
{
	...
	u8 id = 0;
	int var1[10] = {0};
	int i, input_idx = 0, phydm_ary_size = sizeof(phy_dm_ary) /
					       sizeof(struct _PHYDM_COMMAND);
	char help[] = "-h";
	...
	case PHYDM_DIG:
		...
		phydm_dig_debug(p_dm, &input[0], &used, output, &out_len,
				input_num);
		break;
...
/*PHYDM_SNPRINTF((output+used, out_len-used, "odm_PATHDIV_debug\n"));*/
	...
	case PHYDM_DEBUG:
		...
		phydm_debug_trace(p_dm, &input[0], &used, output, &out_len);
	...
	case PHYDM_FW_DEBUG:
		...
		if (input_idx >= 1)
			phydm_fw_debug_trace(p_dm, (u32 *)var1, &used, output,
					     &out_len);
	...
	case PHYDM_SUPPORT_ABILITY:
		...
		if (input_idx >= 1) {
			...
			phydm_support_ability_debug(p_dm, (u32 *)var1, &used,
						    output, &out_len);
		}
	...
	case PHYDM_RF_SUPPORTABILITY:
		halrf_support_ability_debug(p_dm, &input[0], &used, output,
					    &out_len);
		break;
	...
	case PHYDM_IQK:
		...
		PHYDM_SNPRINTF(
			(output + used, out_len - used, "TRX IQK Trigger\n"));
	...
	case PHYDM_IQK_DEBUG:
		...
		if (input_idx >= 1) {
			...
			if (p_dm->support_ic_type &
				...
				halrf_iqk_debug(p_dm, (u32 *)var1, &used,
						output, &out_len);
			#endif
		}
		break;
	...
	case PHYDM_API:
		phydm_api_adjust(p_dm, &input[0], &used, output, &out_len,
				 input_num);
		break;
	...
	case PHYDM_SET_TXAGC: {
		...
		if ((strcmp(input[1], help) == 0)) {
			...
			if (is_enable_dbg_mode) {
				p_dm->is_disable_phy_api = false;
				phydm_set_txagc(p_dm, (u32 *)var1, &used,
						output, &out_len);
				p_dm->is_disable_phy_api = true;
			} else {
				p_dm->is_disable_phy_api = false;
	...
	case PHYDM_TRX_PATH:
		...
		if (p_dm->support_ic_type & (ODM_RTL8822B | ODM_RTL8197F)) {
			...
			if (is_enable_dbg_mode) {
				p_dm->is_disable_phy_api = false;
				phydm_api_trx_mode(p_dm, (enum bb_path)tx_path,
...
#endif
			phydm_config_trx_path(p_dm, (u32 *)var1, &used, output,
					      &out_len);
	...
	case PHYDM_LA_MODE:
		...
		phydm_lamode_trigger_setting(p_dm, &input[0], &used, output,
					     &out_len, input_num);
		#else
	...
	case PHYDM_SHOW_RXRATE: {
...
#if (RTL8822B_SUPPORT == 1 | RTL8821C_SUPPORT == 1 | RTL8814B_SUPPORT == 1)
		if ((p_dm->support_ic_type & PHYDM_IC_SUPPORT_MU_BFEE) == 0)
			break;
		...
		if (var1[0] == 1)
			...
			for (rate_idx = 0; rate_idx < 40; rate_idx++) {
				p_dm->phy_dbg_info.num_qry_vht_pkt[rate_idx] =
					0;
				p_dm->phy_dbg_info
					.num_qry_mu_vht_pkt[rate_idx] = 0;
			}
		}
#endif
		break;
	...
	case PHYDM_NBI_EN:
		...
		if (input_idx >= 1) {
			phydm_api_debug(p_dm, PHYDM_API_NBI, (u32 *)var1, &used,
					output, &out_len);
			/**/
		}
	...
	case PHYDM_CSI_MASK_EN:
		...
		if (input_idx >= 1) {
			phydm_api_debug(p_dm, PHYDM_API_CSI_MASK, (u32 *)var1,
					&used, output, &out_len);
			/**/
		}
	...
	case PHYDM_NHM:
		phydm_nhm_dbg(p_dm, &input[0], &used, output, &out_len,
			      input_num);
		break;

	case PHYDM_CLM:
		phydm_clm_dbg(p_dm, &input[0], &used, output, &out_len,
			      input_num);
		break;

	#ifdef FAHM_SUPPORT
	case PHYDM_FAHM:
		phydm_fahm_dbg(p_dm, &input[0], &used, output, &out_len,
			       input_num);
		break;
	#endif
	...
	case PHYDM_BB_INFO: {
		...
		if (p_dm->support_ic_type & ODM_RTL8822B && input[1]) {
			PHYDM_SSCANF(input[1], DCMD_DECIMAL, &var1[0]);
			odm_set_bb_reg(p_dm, BBREG_0x1988, 0x003fff00, var1[0]);
			value32 = odm_get_bb_reg(p_dm, BBREG_0xf84, MASKDWORD);
	...
	case PHYDM_H2C:
		...
		if (input_idx >= 1)
			phydm_h2C_debug(p_dm, (u32 *)var1, &used, output,
					&out_len);
	...
	case PHYDM_PSD:
		...
		phydm_psd_debug(p_dm, &input[0], &used, output, &out_len,
				input_num);
		#endif
	...
	case PHYDM_DEBUG_PORT: {
		...
		if (phydm_set_bb_dbg_port(p_dm, BB_DBGPORT_PRIORITY_3,
	...
	case PHYDM_TUNE_PARAMETER:
		phydm_parameter_adjust(p_dm, &input[0], &used, output, &out_len,
				       input_num);
		break;
	...
	case PHYDM_ADAPTIVITY_DEBUG:
		...
		if (input_idx >= 1)
			phydm_adaptivity_debug(p_dm, (u32 *)var1, &used, output,
					       &out_len);
	...
	case PHYDM_FORECE_PT_STATE: {
		...
		phydm_pow_train_debug(p_dm, &input[0], &used, output, &out_len,
				      input_num);
		#else
	...
	case PHYDM_STA_INFO:
		phydm_show_sta_info(p_dm, &input[0], &used, output, &out_len,
				    input_num);
		break;

	case PHYDM_PAUSE_FUNC:
		phydm_pause_func_console(p_dm, &input[0], &used, output,
					 &out_len, input_num);
		break;

	case PHYDM_PER_TONE_EVM:
		phydm_per_tone_evm(p_dm, &input[0], &used, output, &out_len,
				   input_num);
		break;
...
#if (DM_ODM_SUPPORT_TYPE & (ODM_CE | ODM_AP))
s32 phydm_cmd(struct PHY_DM_STRUCT *p_dm, char *input, u32 in_len, u8 flag,
...
void phydm_fw_trace_handler(void *p_dm_void, u8 *cmd_buf, u8 cmd_len)
{
	...
	strncpy((char *)&p_dm->fw_debug_trace[p_dm->c2h_cmd_start],
