...
)
{
	...
	} else if ((rfe_type == 0) || (rfe_type == 3) || (rfe_type == 5) || (rfe_type == 8) || (rfe_type == 10) || (rfe_type == 12) || (rfe_type == 13) || (rfe_type == 14) || (rfe_type == 16)) {
		/* iFEM */
		if (is_channel_2g) {
			/* signal source */
			odm_set_bb_reg(p_dm, 0xcb0, 0xffffff, 0x745774);
...
)
{
	...
	if ((p_dm->rfe_type == 3) || (p_dm->rfe_type == 5) || (p_dm->rfe_type == 12) || (p_dm->rfe_type == 15) || (p_dm->rfe_type == 16)) {
...
)
{
	...
	if (central_ch <= 14) {
		...
		if (reg_8 == 0x1) {
			...
			if ((p_dm->rfe_type == 3) || (p_dm->rfe_type == 5) || (p_dm->rfe_type == 8)) {
